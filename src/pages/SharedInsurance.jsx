  ...
  return (
    <div className="min-h-screen bg-[#F8FAFF] py-12 px-6 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">Verified Insurance Token</h1>
            <p className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em]">Secure Data Access</p>
          </div>
            ...
            <div className="bg-slate-50 p-6 rounded-[2rem] border border-slate-100/50 flex flex-col gap-4">
              <div className="flex justify-between items-center group">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Policy Holder</span>
                </div>
              ...
              <div className="flex justify-between items-center group">
                ...
                <span className="bg-emerald-500 text-white text-[9px] font-black px-3 py-1 rounded-full uppercase tracking-widest">Active Coverage</span>
              </div>
            </div>
            
            <div className="p-6 bg-blue-600 rounded-[2rem] shadow-xl shadow-blue-600/20 text-left relative overflow-hidden group">
              ...
              <p className="text-[10px] font-black text-white/60 uppercase tracking-widest mb-1">Authorization Note</p>
              <p className="text-white text-xs font-bold leading-relaxed">
                This digital security token verifies that the holder has valid and active coverage with MedAgent AI Medical Shield.
              </p>
            </div>
          </div>
          ...
          <div className="pt-6 w-full">
            ...
            >
              <ArrowLeft className="w-4 h-4" /> Exit Secure View
            </Link>
          </div>
        </div>
      </motion.div>
      ...
      <p className="mt-12 text-[10px] font-bold text-slate-400 text-center max-w-[300px] leading-relaxed">
        ...
        Secure verification powered by MedAgent-Auth-Protocol.
      </p>
    </div>
  );
}
